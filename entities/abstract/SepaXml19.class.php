...
class SepaXml19 {
    ...
    static function makeDocument($ficheroXml, array $info) {
    ...
    static function getDocument(array $info) {
     ...
     */
    static function getHeader(array $header) {
        self::put("<GrpHdr>", 2);
    ...
    static function getRecibos(array $info) {
        
        $header = $info['header'];
        
        self::put("<PmtInf>", 2);
        self::put("<PmtInfId>{$header['id']}</PmtInfId>", 3);
    ...
    static function getRecibo(array $recibo) {
    ...
    static function put($texto, $jerarquia = 0) {
